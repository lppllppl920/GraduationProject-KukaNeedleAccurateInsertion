...
public:
	...
	void setupUi(QWidget *SubWindow_ROMFile) {
		if (SubWindow_ROMFile->objectName().isEmpty())
			SubWindow_ROMFile->setObjectName(
					QString::fromUtf8("SubWindow_ROMFile"));
		...
		label_SROMImageFile->setObjectName(
				QString::fromUtf8("label_SROMImageFile"));
		...
		lineEdit_SROMImageFile->setObjectName(
				QString::fromUtf8("lineEdit_SROMImageFile"));
	...
	void retranslateUi(QWidget *SubWindow_ROMFile) {
		SubWindow_ROMFile->setWindowTitle(
				QApplication::translate("SubWindow_ROMFile", "ROM File", 0,
						QApplication::UnicodeUTF8));
		label_SROMImageFile->setText(
				QApplication::translate("SubWindow_ROMFile", "SROM Image File",
						0, QApplication::UnicodeUTF8));
		label_Port->setText(
				QApplication::translate("SubWindow_ROMFile", "Port", 0,
						QApplication::UnicodeUTF8));
		pushButton_Save->setText(
				QApplication::translate("SubWindow_ROMFile", "Save", 0,
						QApplication::UnicodeUTF8));
		pushButton_Browse->setText(
				QApplication::translate("SubWindow_ROMFile", "...", 0,
						QApplication::UnicodeUTF8));
		pushButton_Close->setText(
				QApplication::translate("SubWindow_ROMFile", "Close", 0,
						QApplication::UnicodeUTF8));
	} // retranslateUi
