...
public:
    ...
    void setupUi(QWidget *SubWindow_IlluminatorFiringRate)
    {
        if (SubWindow_IlluminatorFiringRate->objectName().isEmpty())
            SubWindow_IlluminatorFiringRate->setObjectName(QString::fromUtf8("SubWindow_IlluminatorFiringRate"));
        SubWindow_IlluminatorFiringRate->resize(316, 144);
        groupBox_ActivationRate = new QGroupBox(SubWindow_IlluminatorFiringRate);
        groupBox_ActivationRate->setObjectName(QString::fromUtf8("groupBox_ActivationRate"));
    ...
    {
        SubWindow_IlluminatorFiringRate->setWindowTitle(QApplication::translate("SubWindow_IlluminatorFiringRate", "Illuminator Firing Rate", 0, QApplication::UnicodeUTF8));
        groupBox_ActivationRate->setTitle(QApplication::translate("SubWindow_IlluminatorFiringRate", "Activation Rate", 0, QApplication::UnicodeUTF8));
        radioButton->setText(QApplication::translate("SubWindow_IlluminatorFiringRate", "20Hz", 0, QApplication::UnicodeUTF8));
        radioButton_2->setText(QApplication::translate("SubWindow_IlluminatorFiringRate", "30Hz", 0, QApplication::UnicodeUTF8));
        radioButton_3->setText(QApplication::translate("SubWindow_IlluminatorFiringRate", "60Hz", 0, QApplication::UnicodeUTF8));
        pushButton_OK->setText(QApplication::translate("SubWindow_IlluminatorFiringRate", "OK", 0, QApplication::UnicodeUTF8));
        pushButton_Cancel->setText(QApplication::translate("SubWindow_IlluminatorFiringRate", "Cancel", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
