...
public:
    ...
    void setupUi(QWidget *SubWindow_ProgramOptions)
    {
        if (SubWindow_ProgramOptions->objectName().isEmpty())
            SubWindow_ProgramOptions->setObjectName(QString::fromUtf8("SubWindow_ProgramOptions"));
        SubWindow_ProgramOptions->resize(532, 427);
        groupBox_LoggingToaFile = new QGroupBox(SubWindow_ProgramOptions);
        groupBox_LoggingToaFile->setObjectName(QString::fromUtf8("groupBox_LoggingToaFile"));
        ...
        checkBox_LogCOMPortToFile->setObjectName(QString::fromUtf8("checkBox_LogCOMPortToFile"));

        gridLayout->addWidget(checkBox_LogCOMPortToFile, 0, 0, 1, 3, Qt::AlignHCenter);
        ...
        gridLayout->addWidget(checkBox_IncludeTimeStamp, 2, 0, 1, 3, Qt::AlignHCenter);

        checkBox_ClearFileonSystemInitialization = new QCheckBox(gridLayoutWidget);
        checkBox_ClearFileonSystemInitialization->setObjectName(QString::fromUtf8("checkBox_ClearFileonSystemInitialization"));

        gridLayout->addWidget(checkBox_ClearFileonSystemInitialization, 3, 0, 1, 3, Qt::AlignHCenter);

        groupBox_BeepOptions = new QGroupBox(SubWindow_ProgramOptions);
        groupBox_BeepOptions->setObjectName(QString::fromUtf8("groupBox_BeepOptions"));
        ...
        checkBox_BeepSystemOnWARNING->setObjectName(QString::fromUtf8("checkBox_BeepSystemOnWARNING"));
        ...
        lineEdit_BeepWARNINGNum->setObjectName(QString::fromUtf8("lineEdit_BeepWARNINGNum"));
        ...
        lineEdit_BeepERRORNum->setObjectName(QString::fromUtf8("lineEdit_BeepERRORNum"));

        gridLayout_2->addWidget(lineEdit_BeepERRORNum, 0, 2, 1, 1);

        checkBox_BeepSystemOnERROR = new QCheckBox(gridLayoutWidget_2);
        checkBox_BeepSystemOnERROR->setObjectName(QString::fromUtf8("checkBox_BeepSystemOnERROR"));
        ...
        groupBox_Messaging->setObjectName(QString::fromUtf8("groupBox_Messaging"));
        groupBox_Messaging->setGeometry(QRect(20, 280, 491, 80));
        checkBox_DisplayError = new QCheckBox(groupBox_Messaging);
        checkBox_DisplayError->setObjectName(QString::fromUtf8("checkBox_DisplayError"));
    ...
    {
        SubWindow_ProgramOptions->setWindowTitle(QApplication::translate("SubWindow_ProgramOptions", "Program Options", 0, QApplication::UnicodeUTF8));
        groupBox_LoggingToaFile->setTitle(QApplication::translate("SubWindow_ProgramOptions", "Logging To a File", 0, QApplication::UnicodeUTF8));
        pushButton_browse->setText(QApplication::translate("SubWindow_ProgramOptions", "...", 0, QApplication::UnicodeUTF8));
        checkBox_LogCOMPortToFile->setText(QApplication::translate("SubWindow_ProgramOptions", "Log COM port communication to a file", 0, QApplication::UnicodeUTF8));
        label_File->setText(QApplication::translate("SubWindow_ProgramOptions", "File                     ", 0, QApplication::UnicodeUTF8));
        checkBox_IncludeTimeStamp->setText(QApplication::translate("SubWindow_ProgramOptions", "Include time stamp", 0, QApplication::UnicodeUTF8));
        checkBox_ClearFileonSystemInitialization->setText(QApplication::translate("SubWindow_ProgramOptions", "Clear file on system initialization", 0, QApplication::UnicodeUTF8));
        groupBox_BeepOptions->setTitle(QApplication::translate("SubWindow_ProgramOptions", "Beep Options", 0, QApplication::UnicodeUTF8));
        checkBox_BeepSystemOnWARNING->setText(QApplication::translate("SubWindow_ProgramOptions", "Beep system on WARNING return", 0, QApplication::UnicodeUTF8));
        label_Noof->setText(QApplication::translate("SubWindow_ProgramOptions", "No. of", 0, QApplication::UnicodeUTF8));
        label_Noof_2->setText(QApplication::translate("SubWindow_ProgramOptions", "No. of", 0, QApplication::UnicodeUTF8));
        checkBox_BeepSystemOnERROR->setText(QApplication::translate("SubWindow_ProgramOptions", "Beep system on ERROR return", 0, QApplication::UnicodeUTF8));
        label_Num->setText(QApplication::translate("SubWindow_ProgramOptions", "(1-9)", 0, QApplication::UnicodeUTF8));
        label_Num_2->setText(QApplication::translate("SubWindow_ProgramOptions", "(1-9)", 0, QApplication::UnicodeUTF8));
        groupBox_Messaging->setTitle(QApplication::translate("SubWindow_ProgramOptions", "Messaging", 0, QApplication::UnicodeUTF8));
        checkBox_DisplayError->setText(QApplication::translate("SubWindow_ProgramOptions", "Display error messages while in tracking mode\n"
"System needs to restart tracking for setting to take effect", 0, QApplication::UnicodeUTF8));
        pushButton_OK->setText(QApplication::translate("SubWindow_ProgramOptions", "OK", 0, QApplication::UnicodeUTF8));
        pushButton_Cancel->setText(QApplication::translate("SubWindow_ProgramOptions", "Cancel", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
