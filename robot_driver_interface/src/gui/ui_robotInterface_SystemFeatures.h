...
public:
	...
	void setupUi(QWidget *SubWindow_SystemFeatures) {
		if (SubWindow_SystemFeatures->objectName().isEmpty())
			SubWindow_SystemFeatures->setObjectName(
					QString::fromUtf8("SubWindow_SystemFeatures"));
		SubWindow_SystemFeatures->resize(323, 401);
		groupBox_VersionInformation = new QGroupBox(SubWindow_SystemFeatures);
		groupBox_VersionInformation->setObjectName(
				QString::fromUtf8("groupBox_VersionInformation"));
		...
		lineEdit_ActivePortsNum->setObjectName(
				QString::fromUtf8("lineEdit_ActivePortsNum"));
		...
		label_WirelessNum->setObjectName(
				QString::fromUtf8("label_WirelessNum"));

		gridLayout->addWidget(label_WirelessNum, 1, 0, 1, 1);

		lineEdit_ActiveWirelessPorts = new QLineEdit(gridLayoutWidget);
		lineEdit_ActiveWirelessPorts->setObjectName(
				QString::fromUtf8("lineEdit_ActiveWirelessPorts"));
		...
		label_ActiveWirelessPorts->setObjectName(
				QString::fromUtf8("label_ActiveWirelessPorts"));

		gridLayout->addWidget(label_ActiveWirelessPorts, 2, 0, 1, 1);

		label_ActivePortsNum = new QLabel(gridLayoutWidget);
		label_ActivePortsNum->setObjectName(
				QString::fromUtf8("label_ActivePortsNum"));

		gridLayout->addWidget(label_ActivePortsNum, 0, 0, 1, 1);

		lineEdit_WirelessNum = new QLineEdit(gridLayoutWidget);
		lineEdit_WirelessNum->setObjectName(
				QString::fromUtf8("lineEdit_WirelessNum"));
		...
		label_SupportingPortsNum->setObjectName(
				QString::fromUtf8("label_SupportingPortsNum"));

		gridLayout->addWidget(label_SupportingPortsNum, 3, 0, 1, 1);

		lineEdit_SupportingPortsNum = new QLineEdit(gridLayoutWidget);
		lineEdit_SupportingPortsNum->setObjectName(
				QString::fromUtf8("lineEdit_SupportingPortsNum"));
	...
	void retranslateUi(QWidget *SubWindow_SystemFeatures) {
		SubWindow_SystemFeatures->setWindowTitle(
				QApplication::translate("SubWindow_SystemFeatures",
						"System Features", 0, QApplication::UnicodeUTF8));
		groupBox_VersionInformation->setTitle(
				QApplication::translate("SubWindow_SystemFeatures",
						"Version Information", 0, QApplication::UnicodeUTF8));
		groupBox_SystemInformation->setTitle(
				QApplication::translate("SubWindow_SystemFeatures",
						"System Information", 0, QApplication::UnicodeUTF8));
		label_WirelessNum->setText(
				QApplication::translate("SubWindow_SystemFeatures",
						"Number of wireless:", 0, QApplication::UnicodeUTF8));
		label_ActiveWirelessPorts->setText(
				QApplication::translate("SubWindow_SystemFeatures",
						"Number of active wireless ports", 0,
						QApplication::UnicodeUTF8));
		label_ActivePortsNum->setText(
				QApplication::translate("SubWindow_SystemFeatures",
						"Number of active ports:", 0,
						QApplication::UnicodeUTF8));
		label_SupportingPortsNum->setText(
				QApplication::translate("SubWindow_SystemFeatures",
						"Number of ports supporting \n"
								"tool-in-port detection:", 0,
						QApplication::UnicodeUTF8));
		pushButton_OK->setText(
				QApplication::translate("SubWindow_SystemFeatures", "OK", 0,
						QApplication::UnicodeUTF8));
		pushButton_Cancel->setText(
				QApplication::translate("SubWindow_SystemFeatures", "Cancel", 0,
						QApplication::UnicodeUTF8));
	} // retranslateUi
