...
public:
	...
	void setupUi(QDialog *SubWindow_COMPortTimeOut) {
		if (SubWindow_COMPortTimeOut->objectName().isEmpty())
			SubWindow_COMPortTimeOut->setObjectName(
					QString::fromUtf8("SubWindow_COMPortTimeOut"));
		...
		pushButton_Restart->setObjectName(
				QString::fromUtf8("pushButton_Restart"));

		gridLayout->addWidget(pushButton_Restart, 1, 1, 1, 1);

		pushButton_CloseApplication = new QPushButton(gridLayoutWidget);
		pushButton_CloseApplication->setObjectName(
				QString::fromUtf8("pushButton_CloseApplication"));
	...
	void retranslateUi(QDialog *SubWindow_COMPortTimeOut) {
		SubWindow_COMPortTimeOut->setWindowTitle(
				QApplication::translate("SubWindow_COMPortTimeOut",
						"COM Port TimeOut", 0, QApplication::UnicodeUTF8));
		pushButton_Retry->setText(
				QApplication::translate("SubWindow_COMPortTimeOut", "Retry", 0,
						QApplication::UnicodeUTF8));
		pushButton_Restart->setText(
				QApplication::translate("SubWindow_COMPortTimeOut", "Restart",
						0, QApplication::UnicodeUTF8));
		pushButton_CloseApplication->setText(
				QApplication::translate("SubWindow_COMPortTimeOut",
						"Close Application", 0, QApplication::UnicodeUTF8));
		label->setText(
				QApplication::translate("SubWindow_COMPortTimeOut",
						"A timeout occured in COM Port\n"
								"\n"
