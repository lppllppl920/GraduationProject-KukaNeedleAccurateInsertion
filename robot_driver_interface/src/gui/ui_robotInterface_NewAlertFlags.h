...
public:
	...
	void setupUi(QWidget *SubWindow_NewAlertFlags) {
		if (SubWindow_NewAlertFlags->objectName().isEmpty())
			SubWindow_NewAlertFlags->setObjectName(
					QString::fromUtf8("SubWindow_NewAlertFlags"));
	...
	void retranslateUi(QWidget *SubWindow_NewAlertFlags) {
		SubWindow_NewAlertFlags->setWindowTitle(
				QApplication::translate("SubWindow_NewAlertFlags",
						"New Alert Flags", 0, QApplication::UnicodeUTF8));
		groupBox_Flags->setTitle(
				QApplication::translate("SubWindow_NewAlertFlags", "Flags", 0,
						QApplication::UnicodeUTF8));
		label_4->setText(
				QApplication::translate("SubWindow_NewAlertFlags",
						"Bump Detected", 0, QApplication::UnicodeUTF8));
		label_11->setText(
				QApplication::translate("SubWindow_NewAlertFlags",
						"Illuminator", 0, QApplication::UnicodeUTF8));
		label_13->setText(
				QApplication::translate("SubWindow_NewAlertFlags",
						"Left Sensor Temperature", 0,
						QApplication::UnicodeUTF8));
		label_14->setText(
				QApplication::translate("SubWindow_NewAlertFlags",
						"Laser Battery", 0, QApplication::UnicodeUTF8));
		label_9->setText(
				QApplication::translate("SubWindow_NewAlertFlags",
						"Illuminator Voltage", 0, QApplication::UnicodeUTF8));
		label_5->setText(
				QApplication::translate("SubWindow_NewAlertFlags",
						"Main Voltage", 0, QApplication::UnicodeUTF8));
		label_12->setText(
				QApplication::translate("SubWindow_NewAlertFlags",
						"Internal Flash Memory", 0, QApplication::UnicodeUTF8));
		label_2->setText(
				QApplication::translate("SubWindow_NewAlertFlags",
						"System Battery Fault", 0, QApplication::UnicodeUTF8));
		label_3->setText(
				QApplication::translate("SubWindow_NewAlertFlags",
						"Sensor Parameter", 0, QApplication::UnicodeUTF8));
		label_6->setText(
				QApplication::translate("SubWindow_NewAlertFlags",
						"Cable Fault", 0, QApplication::UnicodeUTF8));
		label->setText(
				QApplication::translate("SubWindow_NewAlertFlags",
						"Fatal Parameter", 0, QApplication::UnicodeUTF8));
		label_7->setText(
				QApplication::translate("SubWindow_NewAlertFlags",
						"Sensor Voltage", 0, QApplication::UnicodeUTF8));
		label_15->setText(
				QApplication::translate("SubWindow_NewAlertFlags",
						"Right Sensor Temperature", 0,
						QApplication::UnicodeUTF8));
		label_8->setText(
				QApplication::translate("SubWindow_NewAlertFlags",
						"Firmware Incompatible", 0, QApplication::UnicodeUTF8));
		label_10->setText(
				QApplication::translate("SubWindow_NewAlertFlags",
						"Non-Fatal Parameter Fault", 0,
						QApplication::UnicodeUTF8));
		label_16->setText(
				QApplication::translate("SubWindow_NewAlertFlags",
						"Temperature Characterized High", 0,
						QApplication::UnicodeUTF8));
		label_17->setText(
				QApplication::translate("SubWindow_NewAlertFlags",
						"Main Board Temperature", 0,
						QApplication::UnicodeUTF8));
		label_18->setText(
				QApplication::translate("SubWindow_NewAlertFlags",
						"Temperature Characterized Low", 0,
						QApplication::UnicodeUTF8));
		pushButton_OK->setText(
				QApplication::translate("SubWindow_NewAlertFlags", "OK", 0,
						QApplication::UnicodeUTF8));
	} // retranslateUi
